...
import (
	...
	"github.com/mebobby2/linksrus/textindexer/index"
...
func (i *ElasticSearchIndexer) Index(doc *index.Document) error {
	...
	// The interface{}? Pronounced 'empty interface', it's the interface that specifies no methods at all!
	...
	// Usefil for example when we don't know the schema of a JSON payload
